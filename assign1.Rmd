...
lines(great, col="steelblue3", lwd=results.log[1])
great <- getGreatCircle(Europe, NAWC)
lines(great, col="steelblue3", lwd=results.log[2])
great <- getGreatCircle(NAWC, Asia)
lines(great, col="steelblue3", lwd=results.log[3])
great <- getGreatCircle(NAEC, Europe)
lines(great, col="steelblue3", lwd=results.log[4])
great <- getGreatCircle(NAEC, Asia)
lines(great, col="steelblue3", lwd=results.log[5])
great <- getGreatCircle(Europe, Asia)
lines(great, col="steelblue3", lwd=results.log[6])
